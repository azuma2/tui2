...
<template>
  <div class="login">
    ...
    <div class="card">
      <div class="nakami">
        <div class="narabe"><h2>roguinn</h2></div>
    ...
    <label>
      メールアドレス： <input v-model="email" type="email" required value="テスト" />
    </label>
    <br />
    <label>
      raスワード： <input  v-model="password" type="password" required placeholder="テスト" />
    </label>
    <br />
