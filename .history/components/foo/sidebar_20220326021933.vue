    ...
    <div class="sidebar-wrapper">
      <div class="sidebar-link-area">
        ...
        <div class="syde">
          ...
          <div class="icon2"><img class="icon" src="/img/home.png"></div><NuxtLink to="/"><p class="">ホーム</p></NuxtLink>
        </div>
        <div class="syde">
          <li><div class="icon2"><img class="icon" src="/img/logout.png"></div><NuxtLink to="/logout">ログアウト</NuxtLink></li>
        </div>
